document.querySelector('.reload-buttonaa').addEventListener('mouseenter', function() {
      ...
      function updateSitecheckerMessage() {
          setTimeout(() => {
              ...
              if (officialUrls.includes(pageUrl)) {
                  console.log("DEBUG: Official Supernova URL detected.");
                  iconElement.classList.add("fa", "fa-circle-check", "sitechecker-secure");
                  messageElement.innerHTML = `This link <b>(${pageUrl})</b> is a secure, official Supernova link.`;
              } else {
                  console.log("DEBUG: UNOFFICIAL URL detected!");
                  iconElement.classList.add("fa", "fa-triangle-exclamation", "sitechecker-warning");
                  messageElement.innerHTML = `This link <b>(${pageUrl})</b> is not an official Supernova link. Use at your own risk, or find a list of official Supernova links <a href="https://github.com/kdcrs/Supernova/blob/main/README.md" target="_blank" class="sitechecker-link">here</a>.`;
              }
  ...
  (function () {
      document.addEventListener("DOMContentLoaded", function () {
          console.log("Logging: Supernova started");
          displaySupernovaStarted();
      ...
      function displaySupernovaStarted() {
          let logContainer = document.getElementById("logContainer");
  
          if (!logContainer) {
              setTimeout(displaySupernovaStarted, 100);
              return;
          }
  
          addLogEntry(`[Supernova Log] Supernova started successfully`, true);
      }
      ...
      function logEvent(message) {
          ...
          addLogEntry(`[Supernova Log] ${message}`);
      }
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      function contentFetchingProtocolValidation2(contentFetchingProtocolInput) {
          const contentFetchingProtocolRegex = /^Made by kdcrs!$/;
  ...
  𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗲𝗱 𝗔𝗰𝘁𝗶𝗼𝗻𝘀:
  • Visit [https://github.com/kdcrs/Supernova] and verify your browser is up to date.
  ...
  • If all else fails, visit the above mentioned offical Github page [https://github.com/kdcrs/Supernova] and redownload the latest stable version (Helios v1.𝟽.0).
  `;
  ...
  const trustedSchemes = ['supernova://', 'https://', 'http://'];
  ...
  function openGitHub() {
      window.open('https://github.com/kdcrs/Supernova/', '_blank');
  }
  ...
  <div class="theme-preview" onclick="activatePreview(this)">
    <div class="browser-simulation">
      ...
      <div class="browser-content"><div class="hetitle">Supernova</div><div class="titlelinee"></div><div class="dropmed"></div><div class="send4"></div></div>
    </div>
    <p class="theme-name"><i>Default Dark</i> by kdcrs</p>
  </div>
  ...
  <div class="theme-preview-lightmode" onclick="activatePreview(this)">
    ...
    <p class="theme-name-lightmode"><i>Dark Ember</i> by bromse</p>
      ...
      updateLockIcon(url);
      updateSpecialDivs(url);
      if (url === 'supernova://start' || url === 'supernova://settings' || url === 'supernova://urls') {
  ...
  function updateSpecialDivs() {
      const checkURL = () => {
          ...
          const isHeliosURL = urlInput && urlInput.value.startsWith('supernova://');
  ...
  document.querySelectorAll('.tabaa').forEach((tab, index) => {
      const url = tab.querySelector('.tab-nameaa').textContent === 'New Tab' ? 'supernova://start' : document.getElementById('url-baraa').value;
  ...
  function handleSquareButtonClick() {
      ...
      // Reset URL bar
      document.getElementById('url-baraa').value = 'supernova://start';
  
      // Reset tab content
      updateTabContent('supernova://start', firstTabContent, firstTab);
  
      // Reset tab history
      const history = getTabHistory(0);
      history.history = ['supernova://start'];
      ...
      content.innerHTML = `
          ...
          <ul style="list-style-type: none; padding: 0;">
              <li style="margin-bottom: 15px;">
                  <a href="javascript:void(0);" data-url="supernova://start" class="custom-url-link" style="font-size: 24px; color: #66ffa1; text-decoration: none;">supernova://start&nbsp;<i class="fa-solid fa-link" style="font-size: 18px; color: #66ffa1;"></i></a>
                  <p style="margin: 5px 0 0 0; color: #b3b3b3;">Helios start page</p>
              </li>
              <li style="margin-bottom: 15px;">
                  <a href="javascript:void(0);" data-url="supernova://settings" class="custom-url-link" style="font-size: 24px; color: #66ffa1; text-decoration: none;">supernova://settings&nbsp;<i class="fa-solid fa-link" style="font-size: 18px; color: #66ffa1;"></i></a>
                  <p style="margin: 5px 0 0 0; color: #b3b3b3;">Helios settings page</p>
              </li>
              <li style="margin-bottom: 15px;">
                  <a href="javascript:void(0);" data-url="supernova://urls" class="custom-url-link" style="font-size: 24px; color: #66ffa1; text-decoration: none;">supernova://urls&nbsp;<i class="fa-solid fa-link" style="font-size: 18px; color: #66ffa1;"></i></a>
